...
##################### Load in image files
import os
folder_content=os.listdir(r'C:\Users\vechd\.spyder-py3\instability_calc\VDF_images_helios')
#folder_content.sort()
import skimage.io as io
all_images = []
for i in range(0,len(folder_content)):
  filename = r'C:\Users\vechd\.spyder-py3\instability_calc\VDF_images_helios\\' + folder_content[i]
...
#m.save(r'C:\Users\vechd\.spyder-py3\instability_calc\classification_trained_v2') #alexnet
#m.save(r'C:\Users\vechd\.spyder-py3\instability_calc\classification_trained') #cnn v1
m.save(r'C:\Users\vechd\.spyder-py3\instability_calc\classification_trained_helios') #cnn v1
...
p1=np.where((pred_score>0.55) | (pred_score<0.45))[0]
